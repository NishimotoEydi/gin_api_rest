...
func CriaAlunoMock() {
	aluno := models.Aluno{Nome: "Marcos", CPF: "12345678901", RG: "123456789"}
...
func TestBuscaAlunoPorIDHandler(t *testing.T) {
	...
	assert.Equal(t, "Marcos", alunoMock.Nome)
...
func TestEditaUmAlunoHandler(t *testing.T) {
	...
	aluno := models.Aluno{Nome: "Marcos", CPF: "98765432101", RG: "987654321"}
	...
	assert.Equal(t, "Marcos", alunoMockAtualizado.Nome)
	assert.Equal(t, "98765432101", alunoMockAtualizado.CPF)
